...
import { WindowInfo as WindowInfoType } from '../types';

export const WindowInfo: React.FC<{ window: WindowInfoType | null }> = ({ window }) => {
  if (!window) return <div className="p-2 border-b text-sm text-muted-foreground">No active window selected</div>;
