            ...
            `}</style>
              ...
              <g id="Renders">
                ...
                <g id="tree_outline_parent" data-name="tree outline parent">
                  ...
                  <rect id="child1" className="cls-1" x="14.62" y="8.63" width="5.25" height="5.25" rx="1.11" ry="1.11"/>
                  <rect id="root" className="cls-2" x="4.12" y="1.88" width="5.25" height="5.25" rx="1.11" ry="1.11"/>
                </g>
              </g>
        </symbol>
    );
