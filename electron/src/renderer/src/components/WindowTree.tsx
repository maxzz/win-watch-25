...
const WindowNode: React.FC<{ window: WindowInfo; selectedHandle: string | null; onSelect: (h: string) => void; depth: number }> = ({ window, selectedHandle, onSelect, depth }) => {
...
export const WindowTree: React.FC<WindowTreeProps> = ({ windows, selectedHandle, onSelectWindow, onRefresh }) => {
  return (
